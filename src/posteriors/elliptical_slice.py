# code from https://github.com/wjmaddox/drbayes/blob/master/subspace_inference/posteriors/elliptical_slice.py
...
def elliptical_slice(initial_theta,
                     prior,
                     lnpdf,
                     cur_lnpdf=None,
                     angle_range=None,
...
def slice_sample(initial_theta,
                 lnpdf,
                 cur_lnpdf=None,
                 step_out=True,
                 sigma=None,
